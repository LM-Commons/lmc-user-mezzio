    ...
    public function getDependencies(): array
    {
        return [
            'aliases'    => [
                ...
                'lmcuser_change_password_form'   => Form\ChangePasswordForm::class,
                'lmcuser_change_email_form'      => Form\ChangeEmailForm::class,
            ...
            'factories'  => [
                ...
                Form\ChangeEmailForm::class          => Form\ChangeEmailFormFactory::class,
                ...
                Handler\ChangeEmailHandler::class    => Handler\ChangeEmailHandlerFactory::class,
